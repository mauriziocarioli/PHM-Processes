...
* Install event listeners: https://github.com/mauriziocarioli/PHM-Tracing/releases/tag/v2.1.0[PHM-Tracing]
* Import and deploy the model https://github.com/mauriziocarioli/PHM-Model/releases/tag/v2.1.0[PHM-Model]
* Import and deploy the rules https://github.com/mauriziocarioli/PHM-Rules/releases/tag/v2.1.0[PHM-Rules]
...
* Get the Camel integration Spring Boot app project: https://github.com/mauriziocarioli/PHM-integration-service/releases/tag/v2.1.0[PHM-integration-service]
* Get the end-user UI project: https://github.com/mauriziocarioli/phm-management-ui/releases/tag/v2.1.0[phm-management-ui]
